...
/***/ function(module, exports, __webpack_require__) {
	...
	var _resume = __webpack_require__(2);
	...
	var Resume = function Resume(options) {
	    ...
	    this.elem.innerHTML = (0, _resume2.default)(options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<span class=\"title\">" + (jade.escape(null == (jade_interp = title) ? "" : jade_interp)) + "</span>");}.call(this,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined));;return buf.join("");
	}
